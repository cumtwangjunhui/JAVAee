     ...
     <div style="width:60%;margin:auto auto;">
         ...
         <table class="table table-hover">
            ...
            <tr>
                ...
                <td>${user.phone}</td>
                <td>${user.address}</td>
                <td><a class="btn btn-primary" href="deleteuser?book_id=${user.id}" role="button" >删除用户</a></td>
                <td><a class="btn btn-info" href="updetuser?book_id=${user.id}" role="button">修改信息</a></td> 
