      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown li">
          ...
          <ul class="dropdown-menu">
            <li><a href="login">文艺书</a></li>
            <li><a href="login">科技书</a></li>
            <li><a href="login">生活书</a></li>
            <li><a href="login">经管书</a></li>
          </ul>
        </li>
        <li class="li"><a href="lianxi"><font size="4px" face="幼圆" color="#76CB9A">联系我们</font></a></li>
         <li class="li"><a href="login"><font size="4px" face="幼圆" color="#76CB9A">立即登录</font></a></li>
